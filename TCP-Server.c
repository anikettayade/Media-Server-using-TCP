...
int main(void)
{
	...
	// database creation and connection - class id 02
...
// File transfer code for video audio and text - class id 76
...
//code integration, debugging and testing by all members
